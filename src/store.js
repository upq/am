...
const useStore = create((set, get) => {
  const drums = createAudio('/carmen_angelina.mp3', { threshold: 30, expire: 10 })
  const snare = createAudio('/carmen_angelina.mp3', { threshold: 40, expire: 500 })
  const synth = createAudio('/carmen_angelina.mp3')
  return {
    loaded: false,
    clicked: false,
